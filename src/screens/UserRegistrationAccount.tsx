...
// function UserRegistrationAccount() {
...
//                         pressed && changeColor()
//                         ]}>
//                             <View style={{height: scale(40), width: scale(50), justifyContent: "center", alignItems: "center"}}>
//                                 <FontAwesome5 name="user-alt" size={scale(24)} color={buttonProperties.color1} />
//                             </View>
//                             <View style={{alignItems: "center", marginTop: 0}}>
//                                 <Text style={{fontWeight: "bold", color: "rgb(17 24 39)", fontSize: moderateScale(13)}}>Single</Text>
//                             </View>
//                         </Pressable>
//                         <Pressable style={ ({ pressed }) => [
//                         {backgroundColor: "rgb(34 197 94)", padding: 13,borderRadius: 100, alignItems: "center"},
...
//                         ]}>
//                             <View style={{height: scale(40), width: scale(50), justifyContent: "center", alignItems: "center"}}>
//                                 <FontAwesome6 name="user-group" size={scale(24)} color="rgb(17 24 39)" />
//                             </View>
//                             <View style={{alignItems: "center", marginTop: 0}}>
//                                 <Text style={{fontWeight: "bold", color: "rgb(17 24 39)", fontSize: moderateScale(13)}}>Group</Text>
//                             </View>
//                         </Pressable>
//                     </View>
//                 </View>
...
// export default UserRegistrationAccount
...
function UserRegistrationAccount({ navigation }) {
    const companyName = "UMarket";
    ...
    if (width < 700) {    
        ...
        return (
            ...
            <View style={styles.container}>
                ...
                <View style={styles.registrationContainer}>
                    <Text style={{fontWeight: "bold", fontSize: moderateScale(25), marginBottom: 17, color:"rgb(17 24 39)"}}>Account Type</Text>
                    <View style={{flexDirection: "row", gap: 30, marginBottom: verticalScale(17)}}>
                        <Pressable style={ ({ pressed }) => [
                        {backgroundColor: "rgb(34 197 94)", padding: 13,borderRadius: 100, alignItems: "center"},
                        pressed && {backgroundColor: "rgb(17 24 39)"}
